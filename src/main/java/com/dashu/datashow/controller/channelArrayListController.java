...
@Controller
public class channelArrayListController {

  @Autowired
  private PackageListService packageListService;

  @RequestMapping(value = "/pages/channelArrayList.jspa")
  public ModelAndView showPackageListProject(HttpServletRequest request) throws Exception {
    ModelAndView mv = new ModelAndView("/pages/channelArrayList");
    ...
    channelArrayList = doPackage.selectList("select id,createtime,creater,channelCode,channel from channel order by id DESC",5);
